...
from user_management.utils import hash_user_id, InnerIsAuthenticated
...
class ChangePasswordView(APIView):
    ...
    def post(self, request):
        ...
        request_new_password = request_serializer.validated_data[
            'new_password'
        ]
        request_old_password = request_serializer.validated_data[
            'old_password'
        ]
